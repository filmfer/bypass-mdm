...
5. Navigate to https://www.github.com/filmfer/bypass-mdm

6. Copy the script below:

```zsh
curl https://raw.githubusercontent.com/filmfer/bypass-mdm/main/bypass-mdm-v3-PT.sh -o bypass-mdm.sh && chmod +x ./bypass-mdm.sh && ./bypass-mdm.sh
```
